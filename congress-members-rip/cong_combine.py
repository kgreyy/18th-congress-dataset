...
new_df.loc[new_df['rep_name']=='Mercado, Roger G.', 'subdistrict'] = 'Southern Leyte'
new_df.loc[new_df['rep_name']=='Mercado, Roger G.', 'district'] = 'Lone District'
new_df.loc[new_df['rep_name']=='Cua, Junie E.', 'party'] = 'PDP–Laban'
new_df.loc[new_df['rep_name']=='Cua, Junie E.', 'subdistrict'] = 'Quirino'
new_df.loc[new_df['rep_name']=='Cua, Junie E.', 'district'] = 'Lone District'
